...
def get_best_shares_by_knapsack_algorithm(shares: List[Share]):
    ...
    return matrix_of_profits, nb_of_operation


def get_best_portfolio(shares: List[Share]):
    matrix_of_profits, nb_of_operation = get_best_shares_by_knapsack_algorithm(shares)
    ...
    return final_budget, best_profit, best_portfolio, nb_of_operation
